...
//                                    var_dump($solicitudes);
                                    ...
                                    foreach ($solicitudes["data"] as $key => $s) {
                                        ...
                                        echo '<td>' . $s["beneficiario_usuario"]["data"][0]["nombre"] . ' ' . $s["beneficiario_usuario"]["data"][0]["apellidos"] . '</td>';
                                        ...
                                        echo '<td>';
                                        echo '<button class="btn btn-flat btn-danger" onclick="closeR(' . $s["id"] . ');" data-toggle="tooltip" title="Cerrar solicitud"> <i class="fa fa-lock"></i> </button>';
                                        echo '</td>';
                                        echo '</tr>';
                                    }
                                    ?>
...
//                                        -----------------------------------------------------------------------------------
        ...
        function closeR(id) {
            swal({
                ...
                $.post("../controller/controller.php", {evento: 15, id: id}, function (response) {
