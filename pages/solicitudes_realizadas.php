                        ...
                        <div class="box-body">
                            ...
                            <table id="egresos" class="table dt-responsive nowrap table-responsive text-center">
                                ...
                                <tbody id="dirac_solicitudes">
                                    <?php
                                    $solicitudes = $model->getSolicitudesGAC("solicita = " . $_SESSION["sgi_id_usr"]." AND id_tipo != 1 ");
//                                    var_dump($solicitudes);

                                    foreach ($solicitudes["data"] as $key => $s) {

                                        $estatus = intval($s["estatus"]);
                                        echo '<tr>';
                                        echo '<td>' . $s["id"] . '</td>';
                                        ...
                                        echo '<td>';
                                        if ($estatus === 3) {
                                            echo '<a href="ver_solicitud_realizada.php?id=' . $s["id"] . '" data-toggle="tooltip" title="Ver solicitud para carga de archivos" class="btn btn-flat btn-warning"> <i class="fa fa-eye"></i> </a>';
                                        }
                                        echo '</td>';
                                        echo '</tr>';
                                    }
