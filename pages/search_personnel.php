    ...
    <div class="wrapper">    
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1 class="text-aqua">
                    Consulta de solicitudes de salida de personal                    
                </h1>
                <ol class="breadcrumb">
                        ...
                        <div class="box-header">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 form-group">  
                                        &nbsp;
                                        <button name="enviar" id="enviar" value="Buscar" onclick="search_personnel();" class="btn btn-block btn-primary" >Buscar</button>
                                    </div>
                                </div>
                                <!--</form>-->
                            </div>
...
//                            'excel', 'pdf', 'print'
                                            ...
                                            function search_personnel() {
                                                ...
                                                $("#dirac_personnel").html("");
                                                var q = "1=1";
                                                $.post("../controller/dafController.php",
                                                        {evento: 10, fecha_inicio: $("#fecha_inicio").val(), fecha_fin: $("#fecha_fin").val()},
                                                function (response) {
                                                    if (response.errorCode === 0) {
                                                        ...
                                                        $.each(response.data, function (index, value) {
                                                            ...
                                                            var fechaFormulario = value.fecha_salida;
                                                            ...
                                                            records += '<td class="text-' + color_fecha + '">' + value.fecha_salida + '</td>';
                                                            ...
                                                            if (value.hora_regreso !== null) {
                                                                ...
                                                                hora_regreso = "Sin registro"
                                                                color_regreso = 'danger';
                                                            }
                                                            records += '<td class="text-' + color_salida + '">' + hora_salida + '</td>';
                                                            records += '<td class="text-' + color_regreso + '">' + hora_regreso + '</td>';
                                                            records += '</tr>';
                                                        });
                                                        $("#dirac_personnel").append(records);
                                                        $("#projects").dataTable({
                                                            "order": [[4, "asc"]],
                                                            "dom": 'Bfrtip',
                                                            "buttons": [
