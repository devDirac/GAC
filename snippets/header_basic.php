<?php require_once '../config/properties.php'; ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <title>Sistema de Servicios de N&oacute;mina | DIRAC</title>
        ...
        <!-- iCheck -->
        <link href="<?php echo SYSTEM_PATH ?>plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
        <!-- FIGG CSS -->
        <link href="<?php echo SYSTEM_PATH ?>dist/css/figgCss.css" rel="stylesheet" type="text/css" />
