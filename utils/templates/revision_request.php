                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                            <p>La solicitud con nombre de archivo <b style="color: #F89E44"><?php echo $archivo; ?></b> ha registrado un movimiento <br />
                                                ha sido <b style="color: <?php echo $color; ?>"> <?php echo $status_nombre; ?></b> por parte de <b style="color: #F89E44"><?php echo $nombre; ?></b>;en el proceso de autorizaci&oacute;n, por lo cual se solicita tu intervenci&oacute;n .<br /><br />
<!--                                                Si ya tienes una sesi&oacute;n iniciada puedes dar click en el enlace y visualizar la informaci&oacute;n<br /><br />                                                
                                                <a href="<?php // echo SYSTEM_PATH."/pages/auth_document.php?id_solicitud=".$id_solicitud; ?>">Ir a la solicitud</a><br /><br />-->
