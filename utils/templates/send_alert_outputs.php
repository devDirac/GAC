                                    ...
                                    <tr>
                                        <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                            <p align="justify"><?php echo $msg; ?><br /><br />
                                                    ...
                                                    <tbody id="dirac_outputs">
                                                        ...
                                                        foreach ($requests["data"] as $key => $req) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                        <h4><a href="<?php echo SYSTEM_PATH . "/controller/auth_outputs_c.php?id=" . $req["id"] . "&estatus=3";   ?>" title="Autorizar Salida" style="color: green;"> Autorizar</a></h4> 
                                                                    <h4><a href="<?php echo SYSTEM_PATH . "/controller/auth_outputs_c.php?id=" . $req["id"] . "&estatus=2";   ?>" title="Rechazar Salida" style="color: red;">Rechazar</a></h4> 
                                                ...
                                                <p>Por favor entra a <b style="color:orange;">Arjion</b> para <b style="color:green;">autorizar</b> o <b style="color:red;">rechazar</b> la solicitud .</p>
                                                <br />
                                                <br />
                                                <br />
